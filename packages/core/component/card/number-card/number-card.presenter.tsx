  ...
  return (
    <svg width="230" height="343" viewBox="0 0 230 343" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <g clipPath="url(#clip0_53_779)">
        ...
        <text x="47" y="60" textAnchor="middle" className="fill-white font-chango" fontSize={40}>
          {number}
        </text>
        ...
        <text x="47" y="60" textAnchor="middle" transform="rotate(180 115 171)" className="fill-white font-chango" fontSize={40}>
          {number}
        </text>
        ...
        <text x="115" y="225" textAnchor="middle" className={cn('font-chango', variant({ color }))} fontSize={150}>
          {number}
        </text>
